...
SCRIPT_DIR="/mnt/research/tools/LINUX/00_GIT_REPO_KURT/Exome_Joint_Calling_Not_Mendel_Revamp/SNP_VQSR_And_Indel_Hard_Filtered/Scripts/"
...
| awk 'BEGIN{FS=","} NR>1 {print $1,$12,$18,$16}' \
| sed 's/,/\t/g' \
| sort -k 1,1 \
| awk '$1=="'$PROJECT'" {print $1,$2,$3,$4}' \
| sort \
| uniq`)
...
echo \
 qsub -q $QUEUE_LIST \
 -N E04A_EXTRACT_SNV_ONLY_$PROJECT \
 -hold_jid D04_CAT_VARIANTS_$PROJECT \
 -j y -o $CORE_PATH/$PROJECT/LOGS/E04A_EXTRACT_SNV_ONLY.log \
 $SCRIPT_DIR/E04A_EXTRACT_SNV_ONLY.sh \
...
echo \
 ...
 -hold_jid E04A_EXTRACT_SNV_ONLY_$PROJECT \
...
UNIQUE_ID_SM_TAG=$(echo $SM_TAG | sed 's/@/_/g') # If there is an @ in the qsub -q $QUEUE_LIST or holdId name it breaks
}
