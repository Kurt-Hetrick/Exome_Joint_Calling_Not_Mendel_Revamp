...
SCRIPT_DIR="/isilon/sequencing/Kurt/GIT_REPO/VITO/Exome_Joint_Calling_Not_Mendel_Revamp/SNP_And_Indel_Hard_Filtered/Scripts/"
...
# This should be fixed, but need another run to verify

CONCORDANCE_ON_TARGET_PER_SAMPLE(){
echo \
 qsub -q $QUEUE_LIST \
 -N L12_CONCORDANCE_ON_TARGET_PER_SAMPLE_$UNIQUE_ID_SM_TAG \
 -hold_jid K11D_PASSING_SNVS_ON_TARGET_BY_SAMPLE_$UNIQUE_ID_SM_TAG \
...
# Wrong job dependency. fixed above 
